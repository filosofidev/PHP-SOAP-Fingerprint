<html>
<head><title>Koneksi Mesin Absensi Mengunakan SOAP Web Service</title></head>
<body bgcolor="#caffcb">
...
if($HTTP_GET_VARS["ip"]!=""){
	...
	if($Connect){
		...
		$soap_request="<SetUserInfo><ArgComKey Xsi:type=\"xsd:integer\">".$Key."</ArgComKey><Arg><PIN>".$id."</PIN><Card>".$nama."</Card></Arg></SetUserInfo>";
		$newLine="\r\n";
